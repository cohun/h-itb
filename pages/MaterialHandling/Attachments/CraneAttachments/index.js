...
export async function getStaticProps(context) {
  ...
  const res = await client.getEntries({
    content_type: 'productTable', 'fields.productGroupId[all]': 'C.21.',
    locale: 'hu-HU',
  });
...
function Stackers({ type }) {
  return (
    <div>
      <Head>
        <title>Gutman daru adapter</title>
        <meta name="description" content="Gutman daru adapter" />
      </Head>
          ...
          <ul>
            ...
            <li>
              <Link
                ...
                passHref
              >
                <div className="is-active px-3">Daruadapterek</div>
              </Link>
            </li>
          </ul>
        </nav>
