...
export async function getStaticProps(context) {
  ...
  const res = await client.getEntries({
    content_type: 'productTable', 'fields.productGroupId[all]': 'A.11.',
    locale: 'hu-HU',
  });
...
function OverheadCrane({ type }) {
  return (
    <div>
      <Head>
        <title>Futódaruk</title>
        <meta name="description" content="Futódaruk" />
      </Head>
          ...
          <ul>
            ...
            <li>
              <Link href="/LiftingEquipment/CraneAndTrolley/Overhead" passHref>
                <div className="is-active px-3">Futódaruk</div>
              </Link>
            </li>
          </ul>
        </nav>
