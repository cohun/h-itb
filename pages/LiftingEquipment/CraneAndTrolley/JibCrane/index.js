...
export async function getStaticProps(context) {
  ...
  const res = await client.getEntries({
    content_type: 'productTable', 'fields.productGroupId[all]': 'A.13.',
    locale: 'hu-HU',
  });
...
function JibCrane({ type }) {
  return (
    <div>
      <Head>
        <title>Konzoldaruk</title>
        <meta name="description" content="Konzoldaruk" />
      </Head>
          ...
          <ul>
            ...
            <li>
              <Link href="/LiftingEquipment/CraneAndTrolley/JibCranes" passHref>
                <div className="is-active px-3">Konzoldaruk</div>
              </Link>
            </li>
          </ul>
        </nav>
